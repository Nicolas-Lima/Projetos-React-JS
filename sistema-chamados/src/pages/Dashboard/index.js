    ...
    if (!isCollectionEmpty) {
      ...
      querySnapshot.forEach(doc => {
        ...
        lista.push({
          ...
          createdFormat: format(docData.created.toDate(), "dd/MM/yyyy"),
          status: docData.status,
          complemento: docData.complemento,
        });
      });
    ...
    <div>
      ...
      <div className="content">
        ...
        <>
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td data-label="#">
                          <button
                            className="action"
                            style={{ backgroundColor: "#3583f6" }} onClick={() => toggleModal(chamado)}>
          ...
          <h1
            style={{ color: "red", marginTop: "45px", fontSize: "60px" }}>
          </h1>
        </>
      </div>
